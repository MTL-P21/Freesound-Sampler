#https://github.com/gabriel-duque/pygame-piano/blob/master/src/music.py
...
key_to_note2 = {
        ...
        pygame.K_z: (12, False, False),  # C0       (azerty: pygame.K_q)
        pygame.K_s: (13, True, False),  # C#/Db0   (azerty: pygame.K_z)
...
key_to_note1 = {
        ...
        # black: a boolean to know if the key is black or white
        # on: a boolean to keep track of if this note is on
        pygame.K_q: (12, False, False),  # C0       (azerty: pygame.K_q)
        pygame.K_2: (13, True, False),  # C#/Db0   (azerty: pygame.K_z)
...
def draw_keyboard(window) -> None:
    ...
    window_width = 500#window.get_width()
    window_height = 300#window.get_height()
    ...
    for key in key_to_note:
        ...
        if not black:
            continue
        if note == 18 or note == 25 or note == 30:  # Skip the inexistant black key between E and F
            left += margin + white_width
